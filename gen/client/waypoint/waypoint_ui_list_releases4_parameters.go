...
for the waypoint UI list releases4 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint UI list releases4 params
func (o *WaypointUIListReleases4Params) WithNamespaceID(namespaceID string) *WaypointUIListReleases4Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint UI list releases4 params
func (o *WaypointUIListReleases4Params) SetNamespaceID(namespaceID string) {
