...
func (o *WaypointListTriggers4OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{application.project}/application/{application.application}/workspace/{workspace.workspace}/triggers][%d] waypointListTriggers4OK  %+v", 200, o.Payload)
}
...
func (o *WaypointListTriggers4Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{application.project}/application/{application.application}/workspace/{workspace.workspace}/triggers][%d] Waypoint_ListTriggers4 default  %+v", o._statusCode, o.Payload)
}
