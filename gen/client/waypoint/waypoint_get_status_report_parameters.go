...
// WithNamespaceID adds the namespaceID to the waypoint get status report params
func (o *WaypointGetStatusReportParams) WithNamespaceID(namespaceID string) *WaypointGetStatusReportParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get status report params
func (o *WaypointGetStatusReportParams) SetNamespaceID(namespaceID string) {
