...
func (o *WaypointGetUser2OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/user/by-username/{user.username.username}][%d] waypointGetUser2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetUser2Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/user/by-username/{user.username.username}][%d] Waypoint_GetUser2 default  %+v", o._statusCode, o.Payload)
}
