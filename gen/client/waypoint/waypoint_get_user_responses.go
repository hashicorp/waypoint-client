...
func (o *WaypointGetUserOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/user/by-id/{user.id.id}][%d] waypointGetUserOK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetUserDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/user/by-id/{user.id.id}][%d] Waypoint_GetUser default  %+v", o._statusCode, o.Payload)
}
