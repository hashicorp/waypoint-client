...
for the waypoint list triggers2 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list triggers2 params
func (o *WaypointListTriggers2Params) WithNamespaceID(namespaceID string) *WaypointListTriggers2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list triggers2 params
func (o *WaypointListTriggers2Params) SetNamespaceID(namespaceID string) {
