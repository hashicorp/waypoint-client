...
func (o *WaypointCompleteOIDCAuthOK) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/oidc/{auth_method.name}/complete][%d] waypointCompleteOIdCAuthOK  %+v", 200, o.Payload)
}
...
func (o *WaypointCompleteOIDCAuthDefault) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/oidc/{auth_method.name}/complete][%d] Waypoint_CompleteOIDCAuth default  %+v", o._statusCode, o.Payload)
}
