...
for the waypoint list deployments2 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list deployments2 params
func (o *WaypointListDeployments2Params) WithNamespaceID(namespaceID string) *WaypointListDeployments2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list deployments2 params
func (o *WaypointListDeployments2Params) SetNamespaceID(namespaceID string) {
