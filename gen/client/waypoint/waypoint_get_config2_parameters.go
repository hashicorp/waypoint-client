...
for the waypoint get config2 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get config2 params
func (o *WaypointGetConfig2Params) WithNamespaceID(namespaceID string) *WaypointGetConfig2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get config2 params
func (o *WaypointGetConfig2Params) SetNamespaceID(namespaceID string) {
