...
// WithNamespaceID adds the namespaceID to the waypoint UI list deployments2 params
func (o *WaypointUIListDeployments2Params) WithNamespaceID(namespaceID string) *WaypointUIListDeployments2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint UI list deployments2 params
func (o *WaypointUIListDeployments2Params) SetNamespaceID(namespaceID string) {
