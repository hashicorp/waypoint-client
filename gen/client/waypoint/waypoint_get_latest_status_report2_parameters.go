...
for the waypoint get latest status report2 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get latest status report2 params
func (o *WaypointGetLatestStatusReport2Params) WithNamespaceID(namespaceID string) *WaypointGetLatestStatusReport2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get latest status report2 params
func (o *WaypointGetLatestStatusReport2Params) SetNamespaceID(namespaceID string) {
