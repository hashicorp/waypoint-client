...
// WithNamespaceID adds the namespaceID to the waypoint list triggers3 params
func (o *WaypointListTriggers3Params) WithNamespaceID(namespaceID string) *WaypointListTriggers3Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list triggers3 params
func (o *WaypointListTriggers3Params) SetNamespaceID(namespaceID string) {
