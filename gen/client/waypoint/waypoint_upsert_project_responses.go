...
/*WaypointUpsertProjectOK handles this case with default header values.
...
func (o *WaypointUpsertProjectOK) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/project][%d] waypointUpsertProjectOK  %+v", 200, o.Payload)
}
...
/*WaypointUpsertProjectDefault handles this case with default header values.
...
func (o *WaypointUpsertProjectDefault) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/project][%d] Waypoint_UpsertProject default  %+v", o._statusCode, o.Payload)
}
