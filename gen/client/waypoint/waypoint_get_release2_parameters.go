...
// WithNamespaceID adds the namespaceID to the waypoint get release2 params
func (o *WaypointGetRelease2Params) WithNamespaceID(namespaceID string) *WaypointGetRelease2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get release2 params
func (o *WaypointGetRelease2Params) SetNamespaceID(namespaceID string) {
