...
for the waypoint list releases operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list releases params
func (o *WaypointListReleasesParams) WithNamespaceID(namespaceID string) *WaypointListReleasesParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list releases params
func (o *WaypointListReleasesParams) SetNamespaceID(namespaceID string) {
