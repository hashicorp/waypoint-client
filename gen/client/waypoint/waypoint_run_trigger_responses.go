...
func (o *WaypointRunTriggerOK) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/trigger/{ref.id}][%d] waypointRunTriggerOK  %+v", 200, o.Payload)
}
...
func (o *WaypointRunTriggerDefault) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/trigger/{ref.id}][%d] Waypoint_RunTrigger default  %+v", o._statusCode, o.Payload)
}
