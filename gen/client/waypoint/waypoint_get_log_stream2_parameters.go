...
for the waypoint get log stream2 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get log stream2 params
func (o *WaypointGetLogStream2Params) WithNamespaceID(namespaceID string) *WaypointGetLogStream2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get log stream2 params
func (o *WaypointGetLogStream2Params) SetNamespaceID(namespaceID string) {
