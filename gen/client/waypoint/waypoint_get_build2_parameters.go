...
// WithNamespaceID adds the namespaceID to the waypoint get build2 params
func (o *WaypointGetBuild2Params) WithNamespaceID(namespaceID string) *WaypointGetBuild2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get build2 params
func (o *WaypointGetBuild2Params) SetNamespaceID(namespaceID string) {
