...
func (o *WaypointListProjectsOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/projects][%d] waypointListProjectsOK  %+v", 200, o.Payload)
}
...
func (o *WaypointListProjectsDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/projects][%d] Waypoint_ListProjects default  %+v", o._statusCode, o.Payload)
}
