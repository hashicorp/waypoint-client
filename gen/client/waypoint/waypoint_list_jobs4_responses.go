...
func (o *WaypointListJobs4OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/jobs/state/{jobState}][%d] waypointListJobs4OK  %+v", 200, o.Payload)
}
...
func (o *WaypointListJobs4Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/jobs/state/{jobState}][%d] Waypoint_ListJobs4 default  %+v", o._statusCode, o.Payload)
}
