...
func (o *WaypointUIListReleasesOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/ui/releases/workspace/{workspace.workspace}][%d] waypointUiListReleasesOK  %+v", 200, o.Payload)
}
...
func (o *WaypointUIListReleasesDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/ui/releases/workspace/{workspace.workspace}][%d] Waypoint_UI_ListReleases default  %+v", o._statusCode, o.Payload)
}
