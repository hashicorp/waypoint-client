...
/*WaypointListUsersOK handles this case with default header values.
...
func (o *WaypointListUsersOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/users][%d] waypointListUsersOK  %+v", 200, o.Payload)
}
...
/*WaypointListUsersDefault handles this case with default header values.
...
func (o *WaypointListUsersDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/users][%d] Waypoint_ListUsers default  %+v", o._statusCode, o.Payload)
}
