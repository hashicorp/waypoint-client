...
for the waypoint set config source operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint set config source params
func (o *WaypointSetConfigSourceParams) WithNamespaceID(namespaceID string) *WaypointSetConfigSourceParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint set config source params
func (o *WaypointSetConfigSourceParams) SetNamespaceID(namespaceID string) {
