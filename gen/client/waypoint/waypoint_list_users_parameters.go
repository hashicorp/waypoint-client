...
// WithNamespaceID adds the namespaceID to the waypoint list users params
func (o *WaypointListUsersParams) WithNamespaceID(namespaceID string) *WaypointListUsersParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list users params
func (o *WaypointListUsersParams) SetNamespaceID(namespaceID string) {
