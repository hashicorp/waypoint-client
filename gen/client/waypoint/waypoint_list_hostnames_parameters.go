...
// WithNamespaceID adds the namespaceID to the waypoint list hostnames params
func (o *WaypointListHostnamesParams) WithNamespaceID(namespaceID string) *WaypointListHostnamesParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list hostnames params
func (o *WaypointListHostnamesParams) SetNamespaceID(namespaceID string) {
