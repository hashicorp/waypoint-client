...
for the waypoint get application operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get application params
func (o *WaypointGetApplicationParams) WithNamespaceID(namespaceID string) *WaypointGetApplicationParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get application params
func (o *WaypointGetApplicationParams) SetNamespaceID(namespaceID string) {
