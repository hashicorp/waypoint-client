...
// WithNamespaceID adds the namespaceID to the waypoint get auth method params
func (o *WaypointGetAuthMethodParams) WithNamespaceID(namespaceID string) *WaypointGetAuthMethodParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get auth method params
func (o *WaypointGetAuthMethodParams) SetNamespaceID(namespaceID string) {
