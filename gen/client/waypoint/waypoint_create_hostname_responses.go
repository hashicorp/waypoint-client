...
func (o *WaypointCreateHostnameOK) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/project/{target.application.application.project}/application/{target.application.application.application}/hostname][%d] waypointCreateHostnameOK  %+v", 200, o.Payload)
}
...
func (o *WaypointCreateHostnameDefault) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/project/{target.application.application.project}/application/{target.application.application.application}/hostname][%d] Waypoint_CreateHostname default  %+v", o._statusCode, o.Payload)
}
