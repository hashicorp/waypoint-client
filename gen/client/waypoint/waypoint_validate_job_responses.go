...
func (o *WaypointValidateJobOK) Error() string {
	return fmt.Sprintf("[POST /jobs/validate][%d] waypointValidateJobOK  %+v", 200, o.Payload)
}
...
func (o *WaypointValidateJobDefault) Error() string {
	return fmt.Sprintf("[POST /jobs/validate][%d] Waypoint_ValidateJob default  %+v", o._statusCode, o.Payload)
}
