...
for the waypoint cancel task operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint cancel task params
func (o *WaypointCancelTaskParams) WithNamespaceID(namespaceID string) *WaypointCancelTaskParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint cancel task params
func (o *WaypointCancelTaskParams) SetNamespaceID(namespaceID string) {
