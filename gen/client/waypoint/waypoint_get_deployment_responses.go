...
func (o *WaypointGetDeploymentOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/deployment/{ref.id}][%d] waypointGetDeploymentOK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetDeploymentDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/deployment/{ref.id}][%d] Waypoint_GetDeployment default  %+v", o._statusCode, o.Payload)
}
