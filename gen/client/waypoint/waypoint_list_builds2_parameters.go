...
for the waypoint list builds2 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list builds2 params
func (o *WaypointListBuilds2Params) WithNamespaceID(namespaceID string) *WaypointListBuilds2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list builds2 params
func (o *WaypointListBuilds2Params) SetNamespaceID(namespaceID string) {
