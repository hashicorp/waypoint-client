...
// WithNamespaceID adds the namespaceID to the waypoint convert invite token params
func (o *WaypointConvertInviteTokenParams) WithNamespaceID(namespaceID string) *WaypointConvertInviteTokenParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint convert invite token params
func (o *WaypointConvertInviteTokenParams) SetNamespaceID(namespaceID string) {
