...
/*WaypointListBuildsOK handles this case with default header values.
...
func (o *WaypointListBuildsOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{application.project}/application/{application.application}/builds][%d] waypointListBuildsOK  %+v", 200, o.Payload)
}
...
/*WaypointListBuildsDefault handles this case with default header values.
...
func (o *WaypointListBuildsDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{application.project}/application/{application.application}/builds][%d] Waypoint_ListBuilds default  %+v", o._statusCode, o.Payload)
}
