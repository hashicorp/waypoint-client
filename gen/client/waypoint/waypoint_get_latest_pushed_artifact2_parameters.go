...
for the waypoint get latest pushed artifact2 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get latest pushed artifact2 params
func (o *WaypointGetLatestPushedArtifact2Params) WithNamespaceID(namespaceID string) *WaypointGetLatestPushedArtifact2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get latest pushed artifact2 params
func (o *WaypointGetLatestPushedArtifact2Params) SetNamespaceID(namespaceID string) {
