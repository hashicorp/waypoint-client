...
for the waypoint get log stream operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get log stream params
func (o *WaypointGetLogStreamParams) WithNamespaceID(namespaceID string) *WaypointGetLogStreamParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get log stream params
func (o *WaypointGetLogStreamParams) SetNamespaceID(namespaceID string) {
