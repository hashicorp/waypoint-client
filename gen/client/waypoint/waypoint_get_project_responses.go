...
func (o *WaypointGetProjectOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{project.project}][%d] waypointGetProjectOK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetProjectDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{project.project}][%d] Waypoint_GetProject default  %+v", o._statusCode, o.Payload)
}
