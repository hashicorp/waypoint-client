...
func (o *WaypointGetOnDemandRunnerConfigOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/on-demand-runner/by-id/{config.id}][%d] waypointGetOnDemandRunnerConfigOK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetOnDemandRunnerConfigDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/on-demand-runner/by-id/{config.id}][%d] Waypoint_GetOnDemandRunnerConfig default  %+v", o._statusCode, o.Payload)
}
