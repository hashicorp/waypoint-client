...
// WithNamespaceID adds the namespaceID to the waypoint UI list releases params
func (o *WaypointUIListReleasesParams) WithNamespaceID(namespaceID string) *WaypointUIListReleasesParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint UI list releases params
func (o *WaypointUIListReleasesParams) SetNamespaceID(namespaceID string) {
