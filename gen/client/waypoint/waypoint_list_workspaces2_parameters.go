...
for the waypoint list workspaces2 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list workspaces2 params
func (o *WaypointListWorkspaces2Params) WithNamespaceID(namespaceID string) *WaypointListWorkspaces2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list workspaces2 params
func (o *WaypointListWorkspaces2Params) SetNamespaceID(namespaceID string) {
