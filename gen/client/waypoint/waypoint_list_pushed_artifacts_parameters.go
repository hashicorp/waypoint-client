...
for the waypoint list pushed artifacts operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list pushed artifacts params
func (o *WaypointListPushedArtifactsParams) WithNamespaceID(namespaceID string) *WaypointListPushedArtifactsParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list pushed artifacts params
func (o *WaypointListPushedArtifactsParams) SetNamespaceID(namespaceID string) {
