...
// WithNamespaceID adds the namespaceID to the waypoint get workspace params
func (o *WaypointGetWorkspaceParams) WithNamespaceID(namespaceID string) *WaypointGetWorkspaceParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get workspace params
func (o *WaypointGetWorkspaceParams) SetNamespaceID(namespaceID string) {
