...
for the waypoint get log stream3 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get log stream3 params
func (o *WaypointGetLogStream3Params) WithNamespaceID(namespaceID string) *WaypointGetLogStream3Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get log stream3 params
func (o *WaypointGetLogStream3Params) SetNamespaceID(namespaceID string) {
