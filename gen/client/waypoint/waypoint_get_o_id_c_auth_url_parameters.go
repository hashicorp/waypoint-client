...
// WithNamespaceID adds the namespaceID to the waypoint get o ID c auth URL params
func (o *WaypointGetOIDCAuthURLParams) WithNamespaceID(namespaceID string) *WaypointGetOIDCAuthURLParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get o ID c auth URL params
func (o *WaypointGetOIDCAuthURLParams) SetNamespaceID(namespaceID string) {
