...
func (o *WaypointGetVersionInfoOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/version][%d] waypointGetVersionInfoOK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetVersionInfoDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/version][%d] Waypoint_GetVersionInfo default  %+v", o._statusCode, o.Payload)
}
