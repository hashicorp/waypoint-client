...
for the waypoint list runners operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list runners params
func (o *WaypointListRunnersParams) WithNamespaceID(namespaceID string) *WaypointListRunnersParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list runners params
func (o *WaypointListRunnersParams) SetNamespaceID(namespaceID string) {
