...
for the waypoint list jobs3 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list jobs3 params
func (o *WaypointListJobs3Params) WithNamespaceID(namespaceID string) *WaypointListJobs3Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list jobs3 params
func (o *WaypointListJobs3Params) SetNamespaceID(namespaceID string) {
