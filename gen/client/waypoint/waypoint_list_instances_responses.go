...
func (o *WaypointListInstancesOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/instances/{deployment_id}][%d] waypointListInstancesOK  %+v", 200, o.Payload)
}
...
func (o *WaypointListInstancesDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/instances/{deployment_id}][%d] Waypoint_ListInstances default  %+v", o._statusCode, o.Payload)
}
