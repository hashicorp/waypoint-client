...
func (o *WaypointExpediteStatusReport4OK) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/project/{release.sequence.application.project}/application/{release.sequence.application.application}/release/{release.sequence.number}/status-report][%d] waypointExpediteStatusReport4OK  %+v", 200, o.Payload)
}
...
func (o *WaypointExpediteStatusReport4Default) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/project/{release.sequence.application.project}/application/{release.sequence.application.application}/release/{release.sequence.number}/status-report][%d] Waypoint_ExpediteStatusReport4 default  %+v", o._statusCode, o.Payload)
}
