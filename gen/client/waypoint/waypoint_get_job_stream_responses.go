...
func (o *WaypointGetJobStreamOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/jobs/stream/{job_id}][%d] waypointGetJobStreamOK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetJobStreamDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/jobs/stream/{job_id}][%d] Waypoint_GetJobStream default  %+v", o._statusCode, o.Payload)
}
