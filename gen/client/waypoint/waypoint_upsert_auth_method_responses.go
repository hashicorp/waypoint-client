...
func (o *WaypointUpsertAuthMethodOK) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/auth-method][%d] waypointUpsertAuthMethodOK  %+v", 200, o.Payload)
}
...
func (o *WaypointUpsertAuthMethodDefault) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/auth-method][%d] Waypoint_UpsertAuthMethod default  %+v", o._statusCode, o.Payload)
}
