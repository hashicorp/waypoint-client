...
for the waypoint get pushed artifact operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get pushed artifact params
func (o *WaypointGetPushedArtifactParams) WithNamespaceID(namespaceID string) *WaypointGetPushedArtifactParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get pushed artifact params
func (o *WaypointGetPushedArtifactParams) SetNamespaceID(namespaceID string) {
