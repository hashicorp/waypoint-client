...
for the waypoint UI list releases3 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint UI list releases3 params
func (o *WaypointUIListReleases3Params) WithNamespaceID(namespaceID string) *WaypointUIListReleases3Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint UI list releases3 params
func (o *WaypointUIListReleases3Params) SetNamespaceID(namespaceID string) {
