...
// WithNamespaceID adds the namespaceID to the waypoint list instances params
func (o *WaypointListInstancesParams) WithNamespaceID(namespaceID string) *WaypointListInstancesParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list instances params
func (o *WaypointListInstancesParams) SetNamespaceID(namespaceID string) {
