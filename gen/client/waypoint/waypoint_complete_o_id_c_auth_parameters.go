...
// WithNamespaceID adds the namespaceID to the waypoint complete o ID c auth params
func (o *WaypointCompleteOIDCAuthParams) WithNamespaceID(namespaceID string) *WaypointCompleteOIDCAuthParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint complete o ID c auth params
func (o *WaypointCompleteOIDCAuthParams) SetNamespaceID(namespaceID string) {
