...
// WithNamespaceID adds the namespaceID to the waypoint UI list deployments params
func (o *WaypointUIListDeploymentsParams) WithNamespaceID(namespaceID string) *WaypointUIListDeploymentsParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint UI list deployments params
func (o *WaypointUIListDeploymentsParams) SetNamespaceID(namespaceID string) {
