...
for the waypoint create hostname operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint create hostname params
func (o *WaypointCreateHostnameParams) WithNamespaceID(namespaceID string) *WaypointCreateHostnameParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint create hostname params
func (o *WaypointCreateHostnameParams) SetNamespaceID(namespaceID string) {
