...
func (o *WaypointCancelTask2OK) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/task/by-job/{ref.job_id}/cancel][%d] waypointCancelTask2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointCancelTask2Default) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/task/by-job/{ref.job_id}/cancel][%d] Waypoint_CancelTask2 default  %+v", o._statusCode, o.Payload)
}
