...
for the waypoint list deployments operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list deployments params
func (o *WaypointListDeploymentsParams) WithNamespaceID(namespaceID string) *WaypointListDeploymentsParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list deployments params
func (o *WaypointListDeploymentsParams) SetNamespaceID(namespaceID string) {
