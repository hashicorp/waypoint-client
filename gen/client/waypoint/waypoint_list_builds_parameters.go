...
// WithNamespaceID adds the namespaceID to the waypoint list builds params
func (o *WaypointListBuildsParams) WithNamespaceID(namespaceID string) *WaypointListBuildsParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list builds params
func (o *WaypointListBuildsParams) SetNamespaceID(namespaceID string) {
