...
func (o *WaypointDeleteAuthMethodOK) Error() string {
	return fmt.Sprintf("[DELETE /waypoint/2022-02-03/namespace/{namespace_id}/auth-method/{auth_method.name}][%d] waypointDeleteAuthMethodOK  %+v", 200, o.Payload)
}
...
func (o *WaypointDeleteAuthMethodDefault) Error() string {
	return fmt.Sprintf("[DELETE /waypoint/2022-02-03/namespace/{namespace_id}/auth-method/{auth_method.name}][%d] Waypoint_DeleteAuthMethod default  %+v", o._statusCode, o.Payload)
}
