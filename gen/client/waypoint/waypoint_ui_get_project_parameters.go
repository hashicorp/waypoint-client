...
for the waypoint UI get project operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint UI get project params
func (o *WaypointUIGetProjectParams) WithNamespaceID(namespaceID string) *WaypointUIGetProjectParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint UI get project params
func (o *WaypointUIGetProjectParams) SetNamespaceID(namespaceID string) {
