...
// WithNamespaceID adds the namespaceID to the waypoint update user params
func (o *WaypointUpdateUserParams) WithNamespaceID(namespaceID string) *WaypointUpdateUserParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint update user params
func (o *WaypointUpdateUserParams) SetNamespaceID(namespaceID string) {
