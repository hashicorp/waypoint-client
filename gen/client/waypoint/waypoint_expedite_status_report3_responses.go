...
func (o *WaypointExpediteStatusReport3OK) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/project/{deployment.sequence.application.project}/application/{deployment.sequence.application.application}/deployment/{deployment.sequence.number}/status-report][%d] waypointExpediteStatusReport3OK  %+v", 200, o.Payload)
}
...
func (o *WaypointExpediteStatusReport3Default) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/project/{deployment.sequence.application.project}/application/{deployment.sequence.application.application}/deployment/{deployment.sequence.number}/status-report][%d] Waypoint_ExpediteStatusReport3 default  %+v", o._statusCode, o.Payload)
}
