...
func (o *WaypointGetLatestBuildOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{application.project}/application/{application.application}/build/latest][%d] waypointGetLatestBuildOK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetLatestBuildDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{application.project}/application/{application.application}/build/latest][%d] Waypoint_GetLatestBuild default  %+v", o._statusCode, o.Payload)
}
