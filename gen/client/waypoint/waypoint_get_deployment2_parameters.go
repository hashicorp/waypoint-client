...
// WithNamespaceID adds the namespaceID to the waypoint get deployment2 params
func (o *WaypointGetDeployment2Params) WithNamespaceID(namespaceID string) *WaypointGetDeployment2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get deployment2 params
func (o *WaypointGetDeployment2Params) SetNamespaceID(namespaceID string) {
