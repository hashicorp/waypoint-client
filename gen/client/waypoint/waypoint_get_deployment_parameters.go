...
for the waypoint get deployment operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get deployment params
func (o *WaypointGetDeploymentParams) WithNamespaceID(namespaceID string) *WaypointGetDeploymentParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get deployment params
func (o *WaypointGetDeploymentParams) SetNamespaceID(namespaceID string) {
