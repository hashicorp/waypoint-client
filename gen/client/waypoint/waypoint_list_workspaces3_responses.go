...
func (o *WaypointListWorkspaces3OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{application.project}/application/{application.application}/workspaces][%d] waypointListWorkspaces3OK  %+v", 200, o.Payload)
}
...
func (o *WaypointListWorkspaces3Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{application.project}/application/{application.application}/workspaces][%d] Waypoint_ListWorkspaces3 default  %+v", o._statusCode, o.Payload)
}
