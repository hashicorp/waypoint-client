...
func (o *WaypointGetWorkspaceOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/workspace/{workspace.workspace}][%d] waypointGetWorkspaceOK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetWorkspaceDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/workspace/{workspace.workspace}][%d] Waypoint_GetWorkspace default  %+v", o._statusCode, o.Payload)
}
