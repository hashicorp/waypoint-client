...
for the waypoint adopt runner operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint adopt runner params
func (o *WaypointAdoptRunnerParams) WithNamespaceID(namespaceID string) *WaypointAdoptRunnerParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint adopt runner params
func (o *WaypointAdoptRunnerParams) SetNamespaceID(namespaceID string) {
