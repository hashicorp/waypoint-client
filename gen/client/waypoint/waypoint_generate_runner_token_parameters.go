...
for the waypoint generate runner token operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint generate runner token params
func (o *WaypointGenerateRunnerTokenParams) WithNamespaceID(namespaceID string) *WaypointGenerateRunnerTokenParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint generate runner token params
func (o *WaypointGenerateRunnerTokenParams) SetNamespaceID(namespaceID string) {
