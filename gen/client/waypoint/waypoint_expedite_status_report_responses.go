...
func (o *WaypointExpediteStatusReportOK) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/deployment/{deployment.id}/status-report][%d] waypointExpediteStatusReportOK  %+v", 200, o.Payload)
}
...
func (o *WaypointExpediteStatusReportDefault) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/deployment/{deployment.id}/status-report][%d] Waypoint_ExpediteStatusReport default  %+v", o._statusCode, o.Payload)
}
