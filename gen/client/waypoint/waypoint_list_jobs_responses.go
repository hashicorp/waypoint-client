...
/*WaypointListJobsOK handles this case with default header values.
...
func (o *WaypointListJobsOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/jobs/workspace/{workspace.workspace}][%d] waypointListJobsOK  %+v", 200, o.Payload)
}
...
/*WaypointListJobsDefault handles this case with default header values.
...
func (o *WaypointListJobsDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/jobs/workspace/{workspace.workspace}][%d] Waypoint_ListJobs default  %+v", o._statusCode, o.Payload)
}
