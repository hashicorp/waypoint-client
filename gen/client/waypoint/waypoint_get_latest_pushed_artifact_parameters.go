...
for the waypoint get latest pushed artifact operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get latest pushed artifact params
func (o *WaypointGetLatestPushedArtifactParams) WithNamespaceID(namespaceID string) *WaypointGetLatestPushedArtifactParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get latest pushed artifact params
func (o *WaypointGetLatestPushedArtifactParams) SetNamespaceID(namespaceID string) {
