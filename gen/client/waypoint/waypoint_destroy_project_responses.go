...
func (o *WaypointDestroyProjectOK) Error() string {
	return fmt.Sprintf("[DELETE /waypoint/2022-02-03/namespace/{namespace_id}/project/{project.project}][%d] waypointDestroyProjectOK  %+v", 200, o.Payload)
}
...
func (o *WaypointDestroyProjectDefault) Error() string {
	return fmt.Sprintf("[DELETE /waypoint/2022-02-03/namespace/{namespace_id}/project/{project.project}][%d] Waypoint_DestroyProject default  %+v", o._statusCode, o.Payload)
}
