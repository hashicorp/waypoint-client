...
func (o *WaypointUIListDeployments2OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/ui/deployments/application/{application.application}][%d] waypointUiListDeployments2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointUIListDeployments2Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/ui/deployments/application/{application.application}][%d] Waypoint_UI_ListDeployments2 default  %+v", o._statusCode, o.Payload)
}
