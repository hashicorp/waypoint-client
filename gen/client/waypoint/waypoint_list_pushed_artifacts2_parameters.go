...
for the waypoint list pushed artifacts2 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list pushed artifacts2 params
func (o *WaypointListPushedArtifacts2Params) WithNamespaceID(namespaceID string) *WaypointListPushedArtifacts2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list pushed artifacts2 params
func (o *WaypointListPushedArtifacts2Params) SetNamespaceID(namespaceID string) {
