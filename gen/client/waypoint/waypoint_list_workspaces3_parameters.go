...
for the waypoint list workspaces3 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list workspaces3 params
func (o *WaypointListWorkspaces3Params) WithNamespaceID(namespaceID string) *WaypointListWorkspaces3Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list workspaces3 params
func (o *WaypointListWorkspaces3Params) SetNamespaceID(namespaceID string) {
