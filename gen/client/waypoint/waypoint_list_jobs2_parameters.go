...
// WithNamespaceID adds the namespaceID to the waypoint list jobs2 params
func (o *WaypointListJobs2Params) WithNamespaceID(namespaceID string) *WaypointListJobs2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list jobs2 params
func (o *WaypointListJobs2Params) SetNamespaceID(namespaceID string) {
