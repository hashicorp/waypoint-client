...
// WithNamespaceID adds the namespaceID to the waypoint get task params
func (o *WaypointGetTaskParams) WithNamespaceID(namespaceID string) *WaypointGetTaskParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get task params
func (o *WaypointGetTaskParams) SetNamespaceID(namespaceID string) {
