...
func (o *WaypointUpsertApplicationOK) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/project/{project.project}/application][%d] waypointUpsertApplicationOK  %+v", 200, o.Payload)
}
...
func (o *WaypointUpsertApplicationDefault) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/project/{project.project}/application][%d] Waypoint_UpsertApplication default  %+v", o._statusCode, o.Payload)
}
