...
for the waypoint get runner operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get runner params
func (o *WaypointGetRunnerParams) WithNamespaceID(namespaceID string) *WaypointGetRunnerParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get runner params
func (o *WaypointGetRunnerParams) SetNamespaceID(namespaceID string) {
