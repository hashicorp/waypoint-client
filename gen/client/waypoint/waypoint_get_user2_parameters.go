...
for the waypoint get user2 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get user2 params
func (o *WaypointGetUser2Params) WithNamespaceID(namespaceID string) *WaypointGetUser2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get user2 params
func (o *WaypointGetUser2Params) SetNamespaceID(namespaceID string) {
