...
func (o *WaypointListAuthMethodsOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/auth-methods][%d] waypointListAuthMethodsOK  %+v", 200, o.Payload)
}
...
func (o *WaypointListAuthMethodsDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/auth-methods][%d] Waypoint_ListAuthMethods default  %+v", o._statusCode, o.Payload)
}
