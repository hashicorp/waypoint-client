...
for the waypoint set config operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint set config params
func (o *WaypointSetConfigParams) WithNamespaceID(namespaceID string) *WaypointSetConfigParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint set config params
func (o *WaypointSetConfigParams) SetNamespaceID(namespaceID string) {
