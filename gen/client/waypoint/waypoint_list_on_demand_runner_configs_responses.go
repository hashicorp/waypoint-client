...
func (o *WaypointListOnDemandRunnerConfigsOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/on-demand-runners][%d] waypointListOnDemandRunnerConfigsOK  %+v", 200, o.Payload)
}
...
func (o *WaypointListOnDemandRunnerConfigsDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/on-demand-runners][%d] Waypoint_ListOnDemandRunnerConfigs default  %+v", o._statusCode, o.Payload)
}
