...
for the waypoint get config operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get config params
func (o *WaypointGetConfigParams) WithNamespaceID(namespaceID string) *WaypointGetConfigParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get config params
func (o *WaypointGetConfigParams) SetNamespaceID(namespaceID string) {
