...
for the waypoint list status reports operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint list status reports params
func (o *WaypointListStatusReportsParams) WithNamespaceID(namespaceID string) *WaypointListStatusReportsParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list status reports params
func (o *WaypointListStatusReportsParams) SetNamespaceID(namespaceID string) {
