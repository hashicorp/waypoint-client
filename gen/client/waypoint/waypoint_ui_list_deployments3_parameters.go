...
for the waypoint UI list deployments3 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint UI list deployments3 params
func (o *WaypointUIListDeployments3Params) WithNamespaceID(namespaceID string) *WaypointUIListDeployments3Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint UI list deployments3 params
func (o *WaypointUIListDeployments3Params) SetNamespaceID(namespaceID string) {
