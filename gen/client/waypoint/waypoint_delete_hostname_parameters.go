...
// WithNamespaceID adds the namespaceID to the waypoint delete hostname params
func (o *WaypointDeleteHostnameParams) WithNamespaceID(namespaceID string) *WaypointDeleteHostnameParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint delete hostname params
func (o *WaypointDeleteHostnameParams) SetNamespaceID(namespaceID string) {
