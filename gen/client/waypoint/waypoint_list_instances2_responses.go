...
/*WaypointListInstances2OK handles this case with default header values.
...
func (o *WaypointListInstances2OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{application.application.project}/application/{application.application.application}/instances][%d] waypointListInstances2OK  %+v", 200, o.Payload)
}
...
/*WaypointListInstances2Default handles this case with default header values.
...
func (o *WaypointListInstances2Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{application.application.project}/application/{application.application.application}/instances][%d] Waypoint_ListInstances2 default  %+v", o._statusCode, o.Payload)
}
