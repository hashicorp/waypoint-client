...
func (o *WaypointDecodeTokenOK) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/token/decode][%d] waypointDecodeTokenOK  %+v", 200, o.Payload)
}
...
func (o *WaypointDecodeTokenDefault) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/token/decode][%d] Waypoint_DecodeToken default  %+v", o._statusCode, o.Payload)
}
