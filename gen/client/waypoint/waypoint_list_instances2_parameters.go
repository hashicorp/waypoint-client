...
// WithNamespaceID adds the namespaceID to the waypoint list instances2 params
func (o *WaypointListInstances2Params) WithNamespaceID(namespaceID string) *WaypointListInstances2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list instances2 params
func (o *WaypointListInstances2Params) SetNamespaceID(namespaceID string) {
