...
for the waypoint get config3 operation typically these are written to a http.Request
*/
...
// WithNamespaceID adds the namespaceID to the waypoint get config3 params
func (o *WaypointGetConfig3Params) WithNamespaceID(namespaceID string) *WaypointGetConfig3Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get config3 params
func (o *WaypointGetConfig3Params) SetNamespaceID(namespaceID string) {
