...
func (o *WaypointCancelJobOK) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/jobs/cancel/{job_id}][%d] waypointCancelJobOK  %+v", 200, o.Payload)
}
...
func (o *WaypointCancelJobDefault) Error() string {
	return fmt.Sprintf("[PUT /waypoint/2022-02-03/namespace/{namespace_id}/jobs/cancel/{job_id}][%d] Waypoint_CancelJob default  %+v", o._statusCode, o.Payload)
}
