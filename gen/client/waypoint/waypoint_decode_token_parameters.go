...
// WithNamespaceID adds the namespaceID to the waypoint decode token params
func (o *WaypointDecodeTokenParams) WithNamespaceID(namespaceID string) *WaypointDecodeTokenParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint decode token params
func (o *WaypointDecodeTokenParams) SetNamespaceID(namespaceID string) {
