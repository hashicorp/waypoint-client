...
// WithNamespaceID adds the namespaceID to the waypoint queue job params
func (o *WaypointQueueJobParams) WithNamespaceID(namespaceID string) *WaypointQueueJobParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint queue job params
func (o *WaypointQueueJobParams) SetNamespaceID(namespaceID string) {
