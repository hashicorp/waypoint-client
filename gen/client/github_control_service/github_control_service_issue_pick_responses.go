...
/*GithubControlServiceIssuePickOK handles this case with default header values.
...
/*GithubControlServiceIssuePickDefault handles this case with default header values.
...
func (o *GithubControlServiceIssuePickDefault) GetPayload() *models.GrpcGatewayRuntimeError {
	return o.Payload
}
